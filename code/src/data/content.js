...
export const processSteps = [
  {
    number: '01',
    title: 'Discovery',
    desc: 'We start by understanding your business, users, and goals. Through workshops and research, we define the problem space and identify opportunities.',
    deliverables: ['Requirements document', 'User personas', 'Competitive analysis'],
  },
  {
    number: '02',
    title: 'Proposal',
    desc: 'Based on discovery, we present a detailed proposal including scope, timeline, technology recommendations, and transparent pricing.',
    deliverables: ['Technical proposal', 'Project timeline', 'Budget estimate'],
  },
  {
    number: '03',
    title: 'Design',
    desc: 'Our design team creates wireframes, prototypes, and high-fidelity mockups. We iterate based on your feedback until the experience feels right.',
    deliverables: ['Wireframes', 'Interactive prototype', 'Design system'],
  },
  {
    number: '04',
    title: 'Development',
    desc: 'We build in agile sprints with regular demos and feedback cycles. You see progress every two weeks and can adjust priorities as we go.',
    deliverables: ['Working software', 'Sprint demos', 'Technical documentation'],
  },
  {
    number: '05',
    title: 'Testing',
    desc: 'Rigorous QA including automated testing, performance benchmarking, security audits, and user acceptance testing.',
    deliverables: ['Test reports', 'Performance benchmarks', 'Security audit'],
  },
  {
    number: '06',
    title: 'Launch',
    desc: 'We handle deployment, monitoring setup, and go-live support. Our team is on standby during launch to resolve any issues immediately.',
    deliverables: ['Production deployment', 'Monitoring dashboard', 'Launch support'],
  },
  {
    number: '07',
